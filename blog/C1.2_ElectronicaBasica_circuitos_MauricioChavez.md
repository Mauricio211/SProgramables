...
1. Un circuito que tiene una pila de 6 voltios genera una corriente que atraviesa una resistencia eléctrica de 2 ohmios. Cual es el valor de la intensidad de la corriente que pasa por la resistencia?
    ...
    <p align="left">
            <img alt="Circuito1" src="https://github.com/Mauricio211/SProgramables/blob/main/img/Circuito1.png" 
    ...
    + Coloque aquí las imágenes de evidencia de la simulacion,
    
  <p align="left">
        <img alt="act1" src="https://github.com/Mauricio211/SProgramables/blob/main/img/act1.png" 
...
2. Encuentre la tensión de la pila que necesitas para que pase una corriente cuya intensidad es de 3 amperes por una bombilla que tiene 2 ohmios de resistencia.
    ...
    <p align="left">
        <img alt="Circuito2" src="https://github.com/Mauricio211/SProgramables/blob/main/img/Circuito2.png" 
        width=300 height=200>
    </p>
    ...
    <p align="left">
        <img alt="act2" src="https://github.com/Mauricio211/SProgramables/blob/main/img/act2.png" 
        width=300 height=200>
    </p>
...
3. Encuentre la corriente eléctrica total y el voltaje en cada resistencia que se encuentra dentro del circuito, considerando los siguientes valores resistivos,
    ...
    <p align="left">
        <img alt="Circuito3" src="https://github.com/Mauricio211/SProgramables/blob/main/img/Circuito3.png" 
        width=300 height=200>
    </p>
  ...
  + Coloque aquí las imágenes de evidencia de la simulación.
   <p align="left">
        <img alt="act3_1" src="https://github.com/Mauricio211/SProgramables/blob/main/img/act3_1.png" 
        width=300 height=200>
    </p>
    <p align="left">
        <img alt="act3_2" src="https://github.com/Mauricio211/SProgramables/blob/main/img/act3_2.png" 
        width=300 height=200>
    </p>
