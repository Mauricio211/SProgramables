...
<p align="center">
    <img alt="Logo" src="https://github.com/Mauricio211/SProgramables/blob/main/img/C2.2_CS.png" width=700 heigh5t=30>
</p>
...
* **Sensor de temperatura:** Se utiliza para medir dicha temperatura del alambre de plastico y asi daber a cual es necesaria para el proceso.
* **Motor de pasoa paso:** Este es utilizado para introduccion el filamento de plastico y a su vez tiene la salida en la boquilla.
* **Ventilador:** Se utiliza para enfriar el motor.
* **Extrusor:** Es donde s eintroduce el finalmento de plastico para que con la temperatura sea derretido. 
...
:house: [Enlace a mi GitHub](https://github.com/Mauricio211/SProgramables)
