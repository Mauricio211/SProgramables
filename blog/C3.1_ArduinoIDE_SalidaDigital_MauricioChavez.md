...
3. Explique el resultado observado.
   ...
   Se puede observar que el led se mantiene encendido por un segundo y después de ello se apaga por otro segundo, esto se repite indefinidamente debido a que dentro del codigo esta en un loop que no tiene ninguna condicion para detenerse.
...
[Mi repositorio de Github](https://github.com/Mauricio211/SProgramables)